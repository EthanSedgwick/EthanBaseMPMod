...
country = {
	...
	BASE_COUNTRY_TAX_EFFICIENCY = 0.22, -- Basic efficiency for taxes without 'crats and tech -- VANILLA 0.2
	...
	BASE_MONTHLY_DIPLOPOINTS = 1.5, -- Base value gain for diplomatic actions each month -- VANILLA - 0.3
	DIPLOMAT_TRAVEL_TIME = -1, -- VANILLA - 14
	PROVINCE_OVERSEAS_PENALTY = 0.005, -- Each province req. this many goods flagged as overseas penalty 
	NONCORE_TAX_PENALTY = -0.10, -- -5% for each non-core in state -- VANILLA -5%
	...
	NEWSPAPER_PRINTING_FREQUENCY = 999999, -- days frequency when the news attempt to be printed (may not print if not enough facts collected, and retry after another X days) DISABLED FOR MP
	NEWSPAPER_TIMEOUT_PERIOD = 999999, -- the max period for news that may be printed. The probability is decreased with time. DISABLED FOR MP
	NEWSPAPER_MAX_TENSION = 999999, -- when tension of printing gets this high, the newspaper will attempt to be printed immediately. DISABLED FOR MP
	NAVAL_BASE_SUPPLY_SCORE_BASE = 2, -- base value that is powered by level of naval base. Determines the naval supplying capabilities. VANILLA - 10
	...
	MOBILIZATION_SPEED_RAILS_MULT = 3.5, -- Speed modifier for raising troops. It's max value for max railways level in state. VANILLA - 3.0
...
economy = {
	...
	CAPITALIST_BUILD_FACTORY_STATE_EMPLOYMENT_PERCENT = 1.1, -- Capis don't build factories if less than this percent is employed in existing factories VANILLA - 0.7
	...
	MIN_NUM_FACTORIES_PER_STATE_BEFORE_DELETING_LASSIEZ_FAIRE = 9, -- Min number of factories per state before starting to delete under Lassiez Faire VANILLA - 2
	...
	FACTORY_UPGRADE_EMPLOYEE_FACTOR = 0.75, -- determines how close to the employee limit we need to be before "upgrade all" will upgrade/expand a given factory (1 = 100%). -- VANILLA - 0.8
	...
	RGO_SUPPLY_DEMAND_FACTOR_FIRE = 0.02,		-- how fast pops are Fired when there is a low demand -- VANILLA 0.4
...
military = {
	...
	GAS_ATTACK_MODIFIER = 1, -- VANILLA - 3
	...
	NAVAL_COMBAT_STACKING_TARGET_CHANGE = 0.1, -- increase chance to change/drop target when suffering stacking penalty VANILLA - 0.03
	NAVAL_COMBAT_STACKING_TARGET_SELECT = 0.3, -- modifier for how much the stacking penalty affects the target selection. VANILLA - 0.2
	NAVAL_COMBAT_MAX_TARGETS = 4, -- max number of ships that may target the same enemy ship -- VANILLA - 6
	...
	AI_CAVALRY_PROPORTION = 0.1, -- fraction of brigades that should be cavalry -- VANILLA 0.15
	AI_SUPPORT_PROPORTION = 0.5, -- fraction of brigades that should be artillery and other support units -- VANILLA 0.3
	AI_SPECIAL_PROPORTION = 0, -- fraction of brigades that should be engineers and tanks -- VANILLA 0.15
...
diplomacy = {
	...
	MAKE_CB_RELATION_LIMIT = 120, -- VANILLA 100
	...
	TENSION_FROM_MOVEMENT = 0.001, -- tension per 1000 in nationalist movement
	...
	TENSION_ON_CB_DISCOVERED = 0.01,
	TENSION_ON_REVOLT = 0.01,
	TENSION_WHILE_CRISIS = -1.0,
	CRISIS_COOLDOWN_MONTHS = 6000,
	...
	TWS_CB_LIMIT_DEFAULT = 75, -- VANILLA - 100
	...
	LARGE_POPULATION_INFLUENCE_PENALTY = -0.25, -- VANILLA - -0.4
...
pops = {
	...
	REDUCTION_AFTER_DEFEAT = 4.0, -- After a rebellion is being defeated in combat, its pop militancy will be divided by this number. VANILLA - 3.0
...
ai =
{
	...
	PEACE_BASE_RELUCTANCE = 15, -- AI base stubbornness to refuse peace (always applied) -- VANILLA - 20
